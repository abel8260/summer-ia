...
<html lang="en">
  <head>
    ...
    <title>SUmmer:R v2.2 - events </title>
...
"
  ...
  <path d="M16 14V5H0v9a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2zm-6.664-1.21c-1.11 0-1.656-.767-1.703-1.407h.683c.043.37.387.82 1.051.82.844 0 1.301-.848 1.305-2.164h-.027c-.153.414-.637.79-1.383.79-.852 0-1.676-.61-1.676-1.77 0-1.137.871-1.809 1.797-1.809 1.172 0 1.953.734 1.953 2.668 0 1.805-.742 2.871-2 2.871zm-2.89-5.435v5.332H5.77V8.079h-.012c-.29.156-.883.52-1.258.777V8.16a12.6 12.6 0 0 1 1.313-.805h.632z"/>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
          <div class="btn-group me-2">
            <form action="eventos.php"   method="GET">  
              <input class="form-control form-control-danger w-100" type="text" placeholder="nome da chamada" name='date_str'  >
              <input class="form-control form-control-danger w-100" type="date" placeholder="prazo inicial"  name='prazo_ini' >
              <input class="form-control form-control-danger w-100" type="date" placeholder="prazo final"  name='prazo_fim' >
              <input class="form-control form-control-danger w-100" type="text" placeholder="tag"  name='tag_date' >
              <input class="form-control form-control-danger w-100" type="text" placeholder="description" name='log_date' >
              <button type="submit"  name="namebtn" class="btn btn-sm btn-outline-secondary">enviar</button>
            </form>
          </div>
      ...
      <h6>MY: "SELECT * FROM `datas` ORDER BY `datas`.`prazo_fim` ASC "  </6>
        ...
        <table class="table table-striped table-sm">
          <thead>
            <tr>
              ...
              <th scope="col">Nome da chamada </th>
 ...
 $sql=$pdo->prepare("SELECT * FROM `datas` ORDER BY `datas`.`prazo_fim` ASC ");
    ...
    $ini= date("d m Y", strtotime($value['prazo_ini']));
    $fim= date("d m Y", strtotime($value['prazo_fim']));
      ...
      echo "<td>".$value['pro_str']."</td>";

      echo "<td>".$ini."</td>";

      echo "<td>".$fim."</td>";

      echo "<td>".$value['tag_date']."</td>";      

      echo "<td>".$value['log_date']."</td>";
