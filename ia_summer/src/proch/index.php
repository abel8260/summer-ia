...
"
  ...
  <path d="M13 2.5a1.5 1.5 0 0 1 3 0v11a1.5 1.5 0 0 1-3 0v-11zm-1 .724c-2.067.95-4.539 1.481-7 1.656v6.237a25.222 25.222 0 0 1 1.088.085c2.053.204 4.038.668 5.912 1.56V3.224zm-8 7.841V4.934c-.68.027-1.399.043-2.008.053A2.02 2.02 0 0 0 0 7v2c0 1.106.896 1.996 1.994 2.009a68.14 68.14 0 0 1 .496.008 64 64 0 0 1 1.51.048zm1.39 1.081c.285.021.569.047.85.078l.253 1.69a1 1 0 0 1-.983 1.187h-.548a1 1 0 0 1-.916-.599l-1.314-2.48a65.81 65.81 0 0 1 1.692.064c.327.017.65.037.966.06z"/>
          ...
          <li class="nav-item">
            <a class="nav-link active" href="../proch/">
...
<li class="nav-item">
      ...
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
          <div class="btn-group me-2">
            <form action="proch.php"   method="GET">  
              <input class="form-control form-control-danger w-100" type="text" placeholder="nome da chamada" name='pro_str'  >
              <input class="form-control form-control-danger w-100" type="text" placeholder="tecnologia"  name='tech' >
              <input class="form-control form-control-danger w-100" type="number" placeholder="custo" name='custo' >
              <input class="form-control form-control-danger w-100" type="text" placeholder="pasta"  name='folder_pro' >
              <input class="form-control form-control-danger w-100" type="text" placeholder="log da chamada" name='log_pro' >
 ...
 $sql=$pdo->prepare("SELECT * FROM pills ORDER BY id DESC LIMIT 8  ");
    ...
    foreach ($info as $key => $value ){
      ...
      echo "<td>".$value['tech']."</td>";

      echo "<td>".$value['custo']."</td>";

      echo "<td>".$value['folder_pro']."</td>";      

      echo "<td>".$value['log_pro']."</td>";
